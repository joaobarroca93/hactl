...
| Service | Notes |
|---|---|
| `homeassistant.restart` | Restart HA — **restricted** |
| `homeassistant.stop` | Stop HA — **restricted** |
| `homeassistant.check_config` | Validate config files |
| `homeassistant.reload_all` | Reload all YAML config |
